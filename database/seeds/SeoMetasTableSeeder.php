...
class SeoMetasTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('seo_metas')->insert([
                ['url' => '/', 'title' => 'Home | Vrent Home', 'description' => 'Vacation Rentals, Cabins, Beach Houses, Unique Homes & Experiences', 'keywords' => ''],
                ...
                ['url' => 'user/favourite', 'title' => 'Favourite List', 'description' => '', 'keywords' => ''],
