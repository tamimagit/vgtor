...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['guest:admin']], function () {
    ...
    Route::group(['middleware' => 'permission:general_setting'], function () {
        ...
        // Mobile banking CRUD route
        Route::get('settings/mobile-banking', 'MobileBankingController@index');
        Route::match(array('GET', 'POST'), 'settings/add-mobile-banking', 'MobileBankingController@add');
        Route::match(array('GET', 'POST'), 'settings/edit-mobile-banking/{id}', 'MobileBankingController@update');
        Route::get('settings/delete-mobile-banking/{id}', 'MobileBankingController@delete');
        // Mobile banking CRUD route

        // Custom database migrate route
        Route::get('settings/migrate', function () {
