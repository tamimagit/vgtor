    ...
    <div class="container-fluid bg-white main-panel border-0 p-0 mt-70">
        <div class="row">
            ...
            <div class="col-md-7  hidden-pod filter-h" id="listCol">
                <div class="row mt-4">
                    <h2 class="p-2">{{trans('messages.search.results_for')}} <strong
                            class="text-24">{{$location}}</strong></h2>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    <div>
                        <ul class="list-inline  pl-4">
                            <li class="list-inline-item mt-4">
                                <div class="dropdown">
                                    <button class="btn text-16 border border-r-25 pl-4 pr-4 dropdown-toggle"
                            ...
                            <li class="list-inline-item  mt-4">
                                <button class="btn text-16 border border-r-25 pl-4 pr-4 dropdown-toggle" type="button"
                                        id="dropdownRoomType" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                            ...
                                            <div class="col-md-12">
                                                @if($rws==1)
                                                    <div class="d-flex justify-content-between pr-4">
                                                        <div>
                                                            <p class="text-16"><i
                                                                    class="icon icon-entire-place"></i> {{ $value }}</p>
                                                        </div>
                                                        <div>
                                                            <input type="checkbox" id="space_type_{{ $rws }}"
                                                                   name="space_type[]" value="{{ $rws }}"
                                                                   class="form-check-input" {{ in_array($rws, $space_type_selected)?'checked':'' }}>
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                @if($rws==2)
                                                    <div class="d-flex justify-content-between pr-4">
                                                        <div>
                                                            <p class="text-16"><i
                                                                    class="icon icon-private-room"></i> {{ $value }}</p>
                                                        </div>
                                                        <div>
                                                            <input type="checkbox" id="space_type_{{ $rws }}"
                                                                   name="space_type[]" value="{{ $rws }}"
                                                ...
                                                @if($rws==3)
                                                    <div class="d-flex justify-content-between pr-4">
                                                        <div>
                                                            <p class="text-16"><i
                                                                    class="icon icon-shared-room"></i> {{ $value }}</p>
                                                        </div>
                                                        <div>
                                                            <input type="checkbox" id="space_type_{{ $rws }}"
                                                                   name="space_type[]" value="{{ $rws }}"
                                    ...
                                    <div class="row p-3">
                                        <div class="col-md-12">
                                            <div class="d-flex justify-content-between pr-4">
                                                <div>
                                                    <p class="text-16"><i
                                                            class="fa fa-clock text-beach"></i> {{trans('messages.property_single.request_book')}}
                                                    </p>
                                                </div>
                                                <div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex justify-content-between pr-4">
                                                <div>
                                                    <p class="text-16"><i
                                                            class="fa  fa-bolt text-beach"></i> {{trans('messages.property_single.instant_book')}}
                                                    </p>
                                                </div>
                                                <div>
                                                    <input type="checkbox" name="book_type[]" class="form-check-input"
                            ...
                            <li class="list-inline-item  mt-4">
                                <button type="button" id="more_filters"
                                        class="font-weight-500 btn text-16 border border-r-25 pl-4 pr-4"
                    ...
                    <div class="pr-5">
                        <div class="show-map d-none" id="showMap">
                            <a href="#" class="btn text-16 border"><i
                                    class="fas fa-map-marked-alt"></i> {{ trans('messages.search.show_map') }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-4 mb-5">
                    <div id="pagination">
                        ...
                        <div class="pl-3 text-16 mt-4"><span id="page-from">0</span> – <span
                                id="page-to">0</span> {{ trans('messages.search.of') }} <span
                                id="page-total">0</span> {{trans('messages.search.rentals')}}</div>
                    </div>
                </div>
                <!-- Pagination end -->
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg " role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="w-100 pt-3">
                            <h5 class="modal-title text-20 text-center font-weight-700"
                                id="exampleModalLongTitle">{{ trans('messages.search.more_filters') }}</h5>
                        </div>
                    ...
                    <div class="modal-body modal-body-filter">
                        <div class="row">
                            <div class="col-sm-12">
                                <h5 class="font-weight-700 text-24 mt-2 p-4"
                                    for="user_birthdate">{{ trans('messages.search.size') }}</h5>
                            </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-sm-12">
                                <h5 class="font-weight-700 text-24 pl-4"
                                    for="user_birthdate">{{ trans('messages.search.amenities') }}</h5>
                            </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-sm-12">
                                <h5 class="font-weight-700 text-24 pl-4"
                                    for="user_birthdate">{{ trans('messages.search.property_type') }}</h5>
                            </div>
