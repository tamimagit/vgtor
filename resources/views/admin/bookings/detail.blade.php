                            ...
                            <div class="box-body">
                                ...
                                @if($result->mobile_id)
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-sm-offset-1">
                                            {{ ($result->mobile && $result->mobile->name) ? $result->mobile->name : 'Not Found' }}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
                                        ...
                                        <div class="col-sm-6 col-sm-offset-1">
                                            {{ ($result->mobile && $result->mobile->mobile_no) ? $result->mobile->mobile_no : 'Not Found' }}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">
                                        ...
                                        <div class="col-sm-6 col-sm-offset-1">
                                            {{ ($result->mobile && $result->note) ? $result->note : 'Not Found' }}
                                        </div>
                                    </div>
