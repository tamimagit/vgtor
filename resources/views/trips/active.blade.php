                ...
                <div class="main-panel">
                    <div class="container-fluid min-height">
                                            ...
                                            <div>
                                                <form action="{{url('/trips/active')}}" method="POST" id="my-trip-form">
                                                    ...
                                                    <select class="form-control room-list-status text-14 minus-mt-6"
                                                        ...
                                                        <option
                                                            value="All" {{ $status == "All" ? ' selected="selected"' : '' }}>
                                                            All
                                                        </option>
                                                        <option
                                                            value="Current" {{ $status == "Current" ? ' selected="selected"' : '' }}>
                                                            Current
                                                        </option>
                                                        <option
                                                            value="Upcoming" {{ $status == "Upcoming" ? ' selected="selected"' : '' }}>
                                                            Upcoming
                                                        </option>
                                                        <option
                                                            value="Pending" {{ $status == "Pending" ? ' selected="selected"' : '' }}>
                                                            Pending
                                                        </option>
                                                        <option
                                                            value="Completed" {{ $status == "Completed" ? ' selected="selected"' : '' }}>
                                                            Completed
                                                        </option>
                                                        <option
                                                            value="Expired" {{ $status == "Expired" ? ' selected="selected"' : '' }}>
                                                            Expired
                                                        </option>
                                                    </select>
                                                </form>
                        ...
                        @forelse($bookings as $booking)
                            ...
                            } elseif ($booking->status == 'Pending' && ($booking->payment_method_id == 4 OR $booking->payment_method_id == 5)) {
                                ...
                                <div class="col-md-9 col-xl-8 pl-2">
                                    <div class="row m-0 pr-4">
                                        ...
                                        <div class="col-2 col-sm-3">
                                            <span class="badge vbadge-success text-13 mt-3 p-2 {{ $bookingStatus }}">
                                                {{ $bookingStatus }}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between ">
                                        <div>
                                            ...
                                            <p class="text-14 mt-3">
                                                <i class="fas fa-calendar"></i> {{ date(' M d, Y', strtotime($booking->start_date)) }}
